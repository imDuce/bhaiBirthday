...
function NewFooter() {
  ...
  return (
    <footer>
      ...
      <div className='bg-white w-full h-40 bottom-0 sm:flex sm:flex-row sm:justify-between
      ...
      border border-gray-300 items-center'>
        ...
        <div className='p-3  gap-8 mr-6 h-full items-center '>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
          <Link to="https://www.facebook.com/profile..php?id=100027505608085" target='_blank' className="text-gray-500 hover:text-gray-900">
            <svg
              className="w-4 h-4"
              aria-hidden="true"
          ...
          <Link to="https://www.discordapp.com/users/DUCE#9878" target='_blank' className="text-gray-500 hover:text-gray-900">
            <svg
              className="w-4 h-4"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="https://github.com/imDuce" target='_blank' className="text-gray-500 hover:text-gray-900">
            <svg
              className="w-4 h-4"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="https://www.instagram.com/duce_41?igsh=MXhrODI5MWwyOWo4Nw==" target='_blank' className="text-gray-500 hover:text-gray-900">
            <svg
              className='w-4 h-4'
              viewBox="0 0 24 24"
              role="img"
